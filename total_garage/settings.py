"""
Django settings for total_garage project.
...
SECRET_KEY = 'zn23(b51u82o#@^&2(=prnct9v35qf4sisg$+eq0n448na*)nk'
...
ROOT_URLCONF = 'total_garage.urls'
...
WSGI_APPLICATION = 'total_garage.wsgi.application'
